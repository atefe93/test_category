        ...
        <div class="col-md-5" >
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent" >
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link" type="submit" class="btn btn-primary" href="{{ route('login') }}">{{ __('ورود') }}</a>
                        </li>
                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav-link" type="submit" class="btn btn-primary" href="{{ route('register') }}">{{ __('ثبت نام') }}</a>
                            </li>
                        @endif
                    @else
